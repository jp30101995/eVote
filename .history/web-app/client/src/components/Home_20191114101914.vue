...
<div class="container">
  <div class="posts">
    <h1 align="center">2020 Presidential Election</h1>
      ...
      <div class="col-md-6">
        ...
        <form v-on:submit="registerVoter">
          <b-form-group id="input-group-2" label="Enter Drivers License" label-for="input-2">
            ...
            <b-form-group id="input-group-2" label="Enter Election Card ID" label-for="input-2">
            <b-form-input
              id="input-2"
          ...
          <b-form-group id="input-group-2" label="Enter first name" label-for="input-2">
            <b-form-input
              id="input-2"
            ...
            <b-form-group id="input-group-2" label="Enter last name" label-for="input-2">
            <b-form-input
              id="input-2"
